...
#define b_one 0b00001001001001001001001001001001
#define b_two 0b00000011000011000011000011000011
#define b_four 0b00000011000000001111000000001111
#define b_eight 0b00000011000000000000000011111111
...
inline uint32_t spread_bits(uint32_t x) {
  // HW4: YOUR CODE HERE
  //I honestly don't understand this well and asked for help
  x = (x | (x << 16)) & b_eight;
  x = (x | (x <<  8)) & b_four;
  x = (x | (x <<  4)) & b_two;
  x = (x | (x <<  2)) & b_one;
